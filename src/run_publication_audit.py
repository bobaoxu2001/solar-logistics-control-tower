...
def write_summary(
    ...
    lines = [
        ...
        "",
        f"**Final result: {final_status}.** The repository is portable and locally ready for a public-portfolio review. This local audit does not change repository visibility or rewrite Git history.",
        "",
        "## Automated results",
        "",
        "| Audit | Result | Issues |",
